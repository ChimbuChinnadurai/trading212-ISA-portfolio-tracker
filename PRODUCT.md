...
principles:
  - Every pixel serves the data, not the brand.
  - Warm tactile paper aesthetic (light) / warm dark paper (dark) — never cold navy.
  - Financial colour semantics are inviolable: green = gain, red = loss, amber = warning.
  - Monospace for all numbers. Variable-weight Inter for labels and copy.
---
